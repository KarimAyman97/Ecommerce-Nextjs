...
import { NavigationCategory } from "@/app/_types/types";

export const NavDropDownMenu = ({ menu }: { menu: NavigationCategory }) => {
      ...
      {({ open }) => (
        <>
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <Popover.Panel className="absolute top-12 left-1/4  text-sm text-gray-500">
